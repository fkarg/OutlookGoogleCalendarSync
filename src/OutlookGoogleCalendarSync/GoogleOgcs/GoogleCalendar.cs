...
//using Microsoft.Office.Interop.Outlook_v14_2010;
//using O2010;
using System;
...
namespace OutlookGoogleCalendarSync.GoogleOgcs {
    ...
    public class Calendar {
        ...
        private Event createCalendarEntry(AppointmentItem ai) {
            ...
            //var we = ai.GetInspector.WordEditor.Range.FormatedText.Paste;
            String gMeetInfo = @"{\rtf1\ansi\ansicpg1252\deff0\deflang2057{\fonttbl{\f0\fnil\fcharset0 Calibri;}{\f1\fswiss\fprq2\fcharset0 Calibri;}}
...
{\field{\*\fldinst{HYPERLINK ""https://meet.google.com/mpw-dhqb-cve2""}}{\fldrslt{\ul\cf1 https://meet.google.com/mpw-dhqb-cve}}}\f1\fs22\par
...
\pard\sa200\sl276\slmult1\lang9\f0\par
            ...
            //String currentBody = ai.GetInspector.WordEditor.Range.Text;
            //ai.GetInspector.WordEditor.Range.Text = gMeetInfo;
            O2010.Microsoft.Office.Interop.Outlook.AppointmentItem ai2010 = ai as O2010.Microsoft.Office.Interop.Outlook.AppointmentItem;
            ai2010.RTFBody = System.Text.Encoding.ASCII.GetBytes(gMeetInfo);
            //ai.GetInspector.HTMLEditor.Range.Text = "<b>Hello</b>";
            ai2010.Save();
            return null;
